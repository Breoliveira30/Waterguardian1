...
import { Wifi, PlusCircle, Trash2, Edit, Save, X, AlertTriangle, CheckCircle2, Droplet, RefreshCw } from "lucide-react"
...
export default function Sensores() {
  ...
  const adicionarSensor = () => {
    ...
    // Muda para a aba de sensores para mostrar o novo sensor
      ...
      <div className="container mx-auto px-4 py-8 flex-1">
        ...
        <Tabs defaultValue="sensores" value={activeTab} onValueChange={setActiveTab}>
          <TabsList className="mb-6">
            ...
            <TabsTrigger value="adicionar">Adicionar Sensor</TabsTrigger>
              ...
              <Card className="border-none shadow-lg">
                ...
                <CardContent className="space-y-6">
                  ...
                  <div className="space-y-2">
                    ...
                    <p className="text-muted-foreground">
                      Conecte o sensor ao módulo WiFi seguindo o manual do fabricante. Geralmente, isso envolve conectar
                      os fios do sensor aos pinos corretos do módulo ESP8266 ou ESP32.
                    </p>
                  </div>
                  ...
                  <div className="space-y-2">
                    ...
                    <p className="text-muted-foreground">
                      ...
                      precisará do ID único do dispositivo, que pode ser encontrado na etiqueta do produto ou na tela de
                  ...
                  <Alert>
                    ...
                    <AlertDescription>
                      Para garantir a precisão das medições, recomendamos calibrar o sensor após a instalação. Abra uma
                      torneira com vazão conhecida e compare com a leitura do sensor. Ajustes podem ser necessários no
